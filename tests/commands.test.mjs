...
test("collaborative commands expose pair, inline, debate, and parallel workflows", () => {
  ...
  assert.match(debate, /Codex proposes an alternative/i);
  assert.match(debate, /codex-companion\.mjs" debate --claude-proposal-file/);
  assert.match(debate, /Do not edit files during debate mode/i);
  ...
  assert.match(graph, /timeline \[event-type\]/);
