...
argument-hint: 'status|config|enable|disable|init|update|query|explain|path|context [args]'
...
Supported commands:
- `status`: show provider availability, graph path, node count, and edge count
